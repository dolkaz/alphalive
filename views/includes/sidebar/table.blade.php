<!-- search section -->
                ...
                <div class="share hide-on-med-and-down">
                    <div class="sl primary lighter z-depth-1 white-text">
                        ...
                        <div class="links right">
                            ...
                            <a href="http://www.twitter.com/goalnownow" target="_blank" class="twitter">
                                <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="table-section hide-on-med-and-down">
                    <!-- table head -->
                    <!-- $leagues = array(8, 82, 564, 384, 301) -->
                        ...
                        @foreach ($cron_array as $cron_data)
                            <div>
                                <div class="table-head z-depth-1">
                                    Live Table
                                    <div id="asNavForLeague" class="right">
                                        <a href="#league_next" id="league_next">
                                            <i class="material-icons">keyboard_arrow_left</i>
                                        </a>
                                        <span><?php echo $cron_data->name; ?></span>
                                        <a href="#league_prev" id="league_prev">
                                    ...
                                    <table class="responsive-table stripped">
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach($get_standings as $standing): ?>
                                                ...
                                                <tr>
                                                    <td colspan="2"><?php echo $standing->team_name; ?></td>
