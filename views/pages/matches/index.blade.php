                                        ...
                                        <div class="collapsible-body">
                                                        ...
                                                        <p>
                                                            ...
                                                            @elseif($livescores->data->time->status =='FT')
                                                                <span class="green-text text-accent-3">
                                                                    ...
                                                                    @elseif($livescores->data->time->injury_time !== null)
                                            ...
                                            <div class="tst row">
                                                <ul class="tabs transparent">
                                                    ...
                                                    <li class="tab sa col s6 m3 primary dark"><a href="#oddz">Odds</a></li>
                                                    <li class="tab sa col s6 m3 primary dark"><a href="#commentary">Commentary</a></li>
                                              </ul>
                                            </div>
                                            <!-- // end tab headings // -->
                                                    ...
                                                    <table>
                                                        ...
                                                        @else
                                                            <tr style="margin-top: 30px;">
                                                                <td class="left"></td>
                                                                <td class="center" style="padding: 30px 0;">No Stats Data Available for this match</td>
                                                                <td class="right"></td>
                                                            </tr>
                                                        @endif
                                                        </tbody>
                                            ...
                                            <div id="lineUp" class="row">
                                                <?php if ($livescores->data->formations->localteam_formation == null): ?>
                                                    <!-- check for Formations -->
                                                <?php else: ?>
                                                <div class="formation z-depth-1">
                                                   <img style="width: 100%; height: auto;" src="{{ asset('img/formation/field.svg') }}" alt="">
                                                   <div class="sides">
                                                    <?php 

                                                        // {{ $livescores->data->formations->localteam_formation }}
                                                        // {{ $livescores->data->formations->visitorteam_formation }}

                                                        $localteam_formation = $livescores->data->formations->localteam_formation;
                                                        $localteam_formation = explode('-', $localteam_formation);
                                                        // var_dump($localteam_formation);

                                                        $visitorteam_formation = $livescores->data->formations->visitorteam_formation;
                                                        $visitorteam_formation = explode('-', $visitorteam_formation);
                                                        // var_dump($visitorteam_formation);


                                                    ?>
                                                     <div class="a">
                                                       <div class="goalkeeper"><img src="{{ asset('img/formation/grey.svg') }}" alt=""></div>
                                                       <?php if (count($localteam_formation) == 4): ?>

                                                            <div class="defenders">
                                                                <?php for ($i=0; $i < intval($localteam_formation[0]); $i++) { ?>
                                                                    <img src="{{ asset('img/formation/red.svg') }}" alt="">
                                                                <?php } ?>
                                                            </div>
                                                            <div class="dm">
                                                                <?php for ($i=0; $i < intval($localteam_formation[1]); $i++) { ?>
                                                                    <img src="{{ asset('img/formation/red.svg') }}" alt="">
                                                                <?php } ?>
                                                            </div>
                                                            <div class="mid">
                                                                <?php for ($i=0; $i < intval($localteam_formation[2]); $i++) { ?>
                                                                    <img src="{{ asset('img/formation/red.svg') }}" alt="">
                                                                <?php } ?>
                                                            </div>
                                                            <div class="strikers">
                                                                <?php for ($i=0; $i < intval($localteam_formation[3]); $i++) { ?>
                                                                    <img src="{{ asset('img/formation/red.svg') }}" alt="">
                                                                <?php } ?>
                                                            </div>
                                                     ...
                                                     <div class="b">
                                                       <?php if (count($visitorteam_formation) == 4): ?>

                                                            <div class="defenders">
                                                                <?php for ($i=0; $i < intval($visitorteam_formation[3]); $i++) { ?>
                                                                    <img src="{{ asset('img/formation/blue.svg') }}" alt="">
                                                                <?php } ?>
                                                            </div>
                                                            <div class="dm">
                                                                <?php for ($i=0; $i < intval($visitorteam_formation[2]); $i++) { ?>
                                                                    <img src="{{ asset('img/formation/blue.svg') }}" alt="">
                                                                <?php } ?>
                                                            </div>
                                                            <div class="mid">
                                                                <?php for ($i=0; $i < intval($visitorteam_formation[1]); $i++) { ?>
                                                                    <img src="{{ asset('img/formation/blue.svg') }}" alt="">
                                                                <?php } ?>
                                                            </div>
                                                            <div class="strikers">
                                                                <?php for ($i=0; $i < intval($visitorteam_formation[0]); $i++) { ?>
                                                                    <img src="{{ asset('img/formation/blue.svg') }}" alt="">
                                                                <?php } ?>
                                                            </div>
                                                        ...
                                                        <table>
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <span class="secondary-text semibold" style="padding: 15px 0 5px; display: inline-block;">
                                                                        {{ $livescores->data->localTeam->data->name }} Lineup
                                                                    </span>
                                                                    <!-- <td></td>
                                                                    <td></td>
                                                                    <td></td> -->
                                                        ...
                                                        <table>
                                                            <tbody>
                                                                <tr>
                                                                    <!-- <td></td> -->
                                                                    <!-- <td><div class="team"></div></td> -->
                                                                    <span class="secondary-text semibold" style="padding: 15px 0 5px; display: inline-block;">{{ $livescores->data->visitorTeam->data->name }} Lineup</span>
                                                                    <!-- <td></td>
                                                                    <td></td>
                                                                    <td></td> -->
                                                                </tr>
                                                                ...
                                                                <table>
                                                                    <tbody>
                                                                        <tr>
                                                                            ...
                                                                            <!-- <td><div class="team"></div></td> -->
                                                                            <span class="secondary-text semibold" style="padding: 15px 0 5px; display: inline-block;">
                                                                                {{ $livescores->data->localTeam->data->name }} Substitutes
                                                                            </span>
                                                                            <!-- <td></td>
                                                                            <td></td>
                                                                            <td></td> -->
                                                                ...
                                                                <table>
                                                                    <tbody>
                                                                        <tr>
                                                                            <!-- <td></td> -->
                                                                            <!-- <td><div class="team"></div></td> -->
                                                                            <span class="secondary-text semibold" style="padding: 15px 0 5px; display: inline-block;">{{ $livescores->data->visitorTeam->data->name }} Substitutes</span>
                                                                            <!-- <td></td>
                                                                            <td></td>
                                                                            <td></td> -->
                                                                        </tr>
                                                            ...
                                                            <table>
                                                              <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><!-- <div class="team"></div> --></td>
                                                                    <td class="">
                                                                        @if($livescores->data->referee_id !== null)
                                                                            <strong>{{ $livescores->data->referee->data->fullname }}</strong>
                                                                        @endif
                                                                    </td>
                                                                </tr>
                                            ...
                                            <!-- // End line up section -->
                                                                                        ...
                                                                                        <!-- odds section -->
                                            <div id="oddz" class="row">
                                                <div class="ods col s12 no-padding">
                                                    <ul class="collapsible expandable">
                                                        <li class="bold active row no-margin">
                                                            <div class="collapsible-header primary lighter white-text z-depth-1">
                                                                <div class="col s7"></div>
                                                                <div class="col s1 center-align secondary-text">1</div>
                                                                <div class="col s1 center-align secondary-text">X</div>
                                                                <div class="col s1 center-align secondary-text">2</div>
                                                                <div class="col s2 center-align secondary-text">+31></div>
                                                            </div>

                                                            <div class="collapsible-body">
                                                                <div class="row primary dark rst no-margin">
                                                                    <div class="col s12 white-text asii">
                                                                        <div class="s7 col">
                                                                            <img src=<%= require("./img/nairabet.png") %> alt="">
                                                                        </div>
                                                                        <div class="col s1 center-align">1.50</div>
                                                                        <div class="col s1 center-align">3.50</div>
                                                                        <div class="col s1 center-align">2.50</div>
                                                                        <div class="col s2 center-align">4.50</div>
                                                                    </div>
                                                                    <div class="col s12 white-text asii">
                                                                        <div class="s7 col">
                                                                            <img src=<%= require("./img/nairabet.png") %> alt="">
